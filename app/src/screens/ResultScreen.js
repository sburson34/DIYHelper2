...
import { submitCommunityProject, getRedditDiscussions, getPropertyValueImpact } from '../api/backendClient';
...
export default function ResultScreen({ navigation, route }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      setZip(prefs.zip || '');
      loadInventory();
      // Fire-and-forget: enrich with Reddit discussions + property value impact
      if (project?.title) {
