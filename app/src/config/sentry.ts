...
const C = Constants as unknown as {
  expoConfig?: { extra?: { sentryDsn?: string } };
  manifest?: { extra?: { sentryDsn?: string } };
};

const fromEnv = process.env.EXPO_PUBLIC_SENTRY_DSN;
const fromExtra = C.expoConfig?.extra?.sentryDsn ?? C.manifest?.extra?.sentryDsn;
...
export const SENTRY_DSN: string = fromEnv || fromExtra || HARDCODED_DSN;

export const SENTRY_ENVIRONMENT: string = ENVIRONMENT;

export const SENTRY_RELEASE: string = RELEASE;
